...
const expected = [
  ...
  ['PV-SOCCER-001', 'POXIOL_SOCCER_FullSet.webp', ['/', '/products/soccer-jerseys/', '/school-teamwear/', '/club-teamwear-program/'], 'POXIOL black and neon green soccer kit with jersey shorts and socks', 'POXIOL soccer kit visualization showing jersey, shorts and socks.'],
  ['PV-BASEBALL-001', 'POXIOL_BASEBALL_FullSet.webp', ['/', '/custom-baseball-softball-uniforms/', '/school-teamwear/', '/club-teamwear-program/'], 'POXIOL black white and neon green baseball uniform set', 'POXIOL baseball uniform visualization showing jersey and matching pants.'],
