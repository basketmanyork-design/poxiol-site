...
assert.match(basketballSource, /<BreadcrumbSchema\b/, 'Basketball must output its approved standalone BreadcrumbList.')
assert.doesNotMatch(basketballSource, /<ProductSchema\b/, 'Basketball must not claim Product rich-result eligibility without a supported offer.')
