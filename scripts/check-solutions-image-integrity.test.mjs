...
// CF-HYBRID-03: all six cards await category-specific, rights-verified imagery.
...
if (!sourceOnly) {
  ...
  assert.equal((visibleHtml.match(/Project imagery pending verification/g) || []).length, 6, 'Built /solutions/ must render six verification-pending image placeholders')
