...
if (!sourceOnly) {
  ...
  assert.equal((visibleHtml.match(/Project imagery pending verification/g) || []).length, 2, 'Built /solutions/ must render two verification-pending image placeholders')
