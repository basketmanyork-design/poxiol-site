...
export const faqItem = defineType({
  ...
  fields: [
    ...
    defineField({name: 'sports', title: 'Sports', type: 'array', of: [{type: 'string'}], group: 'meta'}),
    defineField({name: 'products', title: 'Products', type: 'array', of: [{type: 'reference', to: [{type: 'product'}]}], group: 'meta'}),
    defineField({name: 'productCategories', title: 'Product categories', type: 'array', of: [{type: 'reference', to: [{type: 'productCategory'}]}], group: 'meta'}),
    defineField({name: 'pages', title: 'Pages', type: 'array', of: [{type: 'reference', to: [{type: 'sitePage'}]}], group: 'meta'}),
    defineField({name: 'guides', title: 'Guides', type: 'array', of: [{type: 'reference', to: [{type: 'article'}]}], group: 'meta'}),
    defineField({name: 'displayOrder', title: 'Display order', type: 'number', initialValue: 0, group: 'meta'}),
    defineField({name: 'active', title: 'Active', type: 'boolean', initialValue: true, group: 'meta'}),
