...
export default async function Page() {
  ...
  return (
    <>
      ...
      <CmsPageTemplate page={page} beforeFooterSlot={<><ConversionEntryGuide currentIntent="quote" /><section id="quote-form" className="bg-neutral-900 px-5 py-20 md:px-10 md:py-28 xl:px-20"><div className="mx-auto max-w-3xl"><ProjectQualificationForm intent="quote" formType="Get Quote Conversion" publicEmail={chrome.publicEmail} whatsappHref={chrome.whatsappHref} /></div></section></>} />
    </>
  )
}
