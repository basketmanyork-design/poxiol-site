      ...
      <section className="relative overflow-hidden bg-neutral-950 px-5 py-20 md:px-10 md:py-32 xl:px-20">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="sr-only">
            ...
            <p>POXIOL is a factory-direct teamwear manufacturer in China providing custom basketball, soccer and sports uniforms with MOQ 1 set and Sample Production: 2–5 Days After Mockup Confirmation for global B2B buyers.</p>
          </div>
          <div>
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-neutral-400 md:text-xl">
              Custom Teamwear Manufacturer in China. We provide factory-direct basketball, soccer and athletic uniforms with MOQ 1 set and Sample Production: 2–5 Days After Mockup Confirmation for clubs, schools and sportswear brands worldwide.
            </p>

            <div className="mt-10 flex flex-wrap gap-3">
              {["MOQ 1 Set", "Free 3D Mockup", "2–5 Days Sample Production", "Quality Support", "Global Shipping"].map(chip => (
            ...
            <table className="w-full text-left border-collapse min-w-[600px] md:min-w-0">
              ...
              <tbody className="text-sm text-neutral-300">
                {[
                  ...
                  ["Sampling Timeline", "Sample Production: 2–5 Days After Mockup Confirmation with express global delivery."],
