...
const productsFaqs = [
  ...
  { question: "Do you provide samples for all product categories?", answer: "Sample availability is confirmed after the product, design and project requirements are reviewed." }
];
