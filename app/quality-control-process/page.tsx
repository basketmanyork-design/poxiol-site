...
const pageKey = 'quality-control-process'

export async function generateMetadata(): Promise<Metadata> {
  const page = await getSitePage(pageKey)
  return metadataFromCmsPage(page, getV8AuthorityMetadata('quality-control'))
}

export default async function Page() {
  const page = await getSitePage(pageKey)
  return <V8AuthorityPage pageId="quality-control" page={page} />
}
