...
export const metadata: Metadata = {
  ...
  description: "Explore CMS-managed POXIOL resources including buying guides, fabric knowledge, manufacturing knowledge and SEO articles.",
};
    ...
    <main className="bg-[#0A0A0A] text-white selection:bg-[#B6FF00] selection:text-black">
      ...
      <section className="bg-neutral-950 px-5 py-20 md:px-10 md:py-28 xl:px-20">
        <div className="mx-auto max-w-7xl">
          <SectionHeading eyebrow="Knowledge Center" title="Teamwear Knowledge & Buying Guides" subtitle="Resources and guides are backed by CMS articles with legacy fallback." dark center />
