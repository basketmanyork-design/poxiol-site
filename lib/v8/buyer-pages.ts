...
const pageDefinitions = [
  ...
  },
  {
    ...
    purpose: 'For teamwear distributors, dealers, sportswear brands and custom resellers worldwide managing downstream team clients, brand-owned collections and repeat orders.',
    seoTitle: 'Private Label Teamwear for Sports Brands and Distributors | POXIOL',
    seoDescription: 'Private-label teamwear for teamwear distributors, dealers, sportswear brands and custom resellers worldwide. Plan client collections, samples and repeat orders.',
    heroEyebrow: 'For Global Teamwear Channel Partners',
    heroTitle: 'Private Label Teamwear Built Around Your Brand',
    heroDescription: 'For teamwear distributors, dealers, sportswear brands and custom resellers worldwide. Plan your client collections, labels, packaging and sample approvals, then reconfirm specifications and material availability for each reorder.',
    heroPrimaryCtaId: 'get-quote',
    heroSecondaryCtaId: 'request-sample',
    ...
    finalCta: {id: 'get-quote', label: 'Discuss Your OEM Project', href: '/get-quote/', description: 'Share your client program, product brief, authorized brand assets, estimated quantity, packaging needs and target timeline for project review.'},
  },
] as const
