...
export const sportsPages: SportsPageData[] = [
  {
    ...
    metaDescription: "POXIOL manufactures custom basketball uniforms, reversible jerseys, shooting shirts and team sets for clubs, academies and schools with sample, OEM/ODM and production planning support.",
    ...
    procurementTable: [
      ...
      { item: "Sourcing Channel", specification: "Alibaba store link available for buyer reference" }
    ],
    faqs: [
      { question: "What fabric is suitable for custom basketball uniforms?", answer: "Fabric selection is confirmed during project consultation based on the required breathability, durability, finish and intended use." },
      { question: "Is mesh or interlock fabric better for basketball uniforms?", answer: "The suitable construction depends on the required ventilation, finish and panel design. POXIOL confirms the material choice against the project brief." },
      { question: "How is basketball uniform sizing checked?", answer: "The finished jersey and shorts are reviewed against the size chart and tolerance agreed for the project." },
      ...
      { question: "What QC checks are done before shipment?", answer: "Checks cover the confirmed fabric, print alignment, stitching, size details, player names and numbers, and packing requirements." },
      { question: "Can I order a basketball uniform sample before bulk production?", answer: "Sample availability, quantity and timing are confirmed during project consultation before bulk production planning." },
  ...
  },
  {
    ...
    heroImage: "/images/poxiol-teamwear-hero-poxiol-only-v2.webp",
