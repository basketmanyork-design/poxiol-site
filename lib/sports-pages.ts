...
export const sportsPages: SportsPageData[] = [
  {
    ...
    metaDescription: "POXIOL manufactures pro-grade custom basketball uniforms, reversible jerseys, shooting shirts and team sets for clubs, academies and schools. Factory-direct OEM/ODM production with Sample production: 2-3 working days after mockup approval and global shipping.",
