...
export const catalog = Object.freeze({
  ...
  procurement: {
    sampleMinimumOrder: {
      value: 1,
      unit: 'set',
      purpose: 'Design and quality confirmation',
      qualification:
        'This is the sample MOQ. Bulk-order MOQ depends on product type, quantity, fabric, customization and packaging requirements.',
    },
    bulkMinimumOrder: {
      fixedValueAvailable: false,
      qualification:
