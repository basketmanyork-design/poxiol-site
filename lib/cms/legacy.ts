...
export const legacyPages: CmsPage[] = [
  {
    ...
    seo: {
      ...
      description: 'Elite B2B custom teamwear manufacturer offering basketball uniforms, soccer kits and OEM sportswear with free mockup, MOQ 1 set and Sample production: 2-3 working days after mockup approval.',
